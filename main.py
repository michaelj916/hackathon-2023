...
from removeItem import RemoveItem, DoubleClickAdd
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.home_todo.setIconSize(QtCore.QSize(25, 25))
        ...
        self.school_todo.setIconSize(QtCore.QSize(25, 25))
        ...
        self.todo.setIconSize(QtCore.QSize(25, 25))
        ...
        self.work_todo.setIconSize(QtCore.QSize(25, 25))
        ...
        self.counter_todo.setStyleSheet("font: 15pt \"Century Gothic\";\n"
                                        "color: rgb(112, 112, 112);\n"
        ...
        self.todo_addtask.setGeometry(QtCore.QRect(10, 70, 481, 51))
        ...
        self.todo_submit.setGeometry(QtCore.QRect(500, 70, 51, 51))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:\\Users\\mikab\\Downloads\\plus (1).png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        self.todo_submit.setIcon(icon4)
        self.todo_submit.setIconSize(QtCore.QSize(25, 25))
        ...
        self.todo_list_widget.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        ...
        self.stickypad_todo.setStyleSheet("font: 15pt \"Century Gothic\"; 	color: rgb(255, 150, 29);""")
        self.stickypad_todo.setObjectName("stickypad_todo")
        self.stickypad_todo.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        ...
        self.home_submit.setGeometry(QtCore.QRect(500, 70, 51, 51))
        ...
        self.home_submit.setIconSize(QtCore.QSize(25, 35))
        ...
        self.home_counter.setStyleSheet("font: 15pt \"Century Gothic\";\n"
                                        "color: rgb(112, 112, 112);\n"
                                        "border: 3px solid rgb(214, 214, 214) ;\n"
                                        "border-width: 2px;\n"
                                        "border-radius: 5px; font-weight: bold;")
        ...
        self.home_addtask.setGeometry(QtCore.QRect(10, 70, 481, 51))
        ...
        self.school_addtask.setGeometry(QtCore.QRect(10, 70, 481, 51))
        ...
        self.school_submit.setGeometry(QtCore.QRect(500, 70, 51, 51))
        ...
        self.school_submit.setIconSize(QtCore.QSize(25, 25))
        ...
        self.school_counter.setStyleSheet("font: 15pt \"Century Gothic\";\n"
                                          "color: rgb(112, 112, 112);\n"
                                          "border: 3px solid rgb(214, 214, 214) ;\n"
                                          "border-width: 2px;\n"
                                          "border-radius: 5px; font-weight: bold;")
        ...
        self.important_star = QtWidgets.QPushButton(self.todolist)
        self.important_star.setGeometry(QtCore.QRect(-10, 50, 51, 41))
        self.important_star.setStyleSheet("\n"
                                          "QPushButton {\n"
                                          ...
                                          "    \n"
                                          "QPushButton:pressed {\n"
                                          "    font: 21pt \"MS Shell Dlg 2\";\n"
                                          "    background-color: rgba(255, 255, 255,0);\n"
                                          "    color: rgb(216, 127, 24);\n"
                                          "    border-radius: 5px;\n"
                                          "    border: 0px;\n"
                                          " }")
        self.important_star.setIconSize(QtCore.QSize(40, 40))
        self.important_star.setObjectName("important_star")

        self.todo_minus = QtWidgets.QPushButton(self.todolist)
        self.todo_minus.setGeometry(QtCore.QRect(560, 70, 51, 51))
        self.todo_minus.setStyleSheet("\n"
                                      "QPushButton {\n"
                                      "background-color: rgb(234, 234, 234);\n"
                                      "    border: 0px;\n"
                                      "    border-radius: 10px;\n"
                                      ...
                                      "    border: 0px;\n"
                                      " }")
        self.todo_minus.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:\\Users\\mikab\\Downloads\\close.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.todo_minus.setIcon(icon5)
        self.todo_minus.setIconSize(QtCore.QSize(20, 20))
        self.todo_minus.setObjectName("todo_minus")


        self.school_minus = QtWidgets.QPushButton(self.school_todo1)
        self.school_minus.setGeometry(QtCore.QRect(560, 70, 51, 51))
        self.school_minus.setStyleSheet("\n"
                                        "QPushButton {\n"
                                        "background-color: rgb(234, 234, 234);\n"
                                        "    border: 0px;\n"
                                        "    border-radius: 10px;\n"
                                        ...
                                        "    border: 0px;\n"
                                        " }")
        self.school_minus.setText("")
        self.school_minus.setIcon(icon5)
        self.school_minus.setIconSize(QtCore.QSize(25, 25))
        self.school_minus.setObjectName("school_minus")


        self.school_label_background.raise_()
        self.school_addtask.raise_()
        self.school_submit.raise_()
        self.school_minus.raise_()
        ...
        self.work_addtask.setGeometry(QtCore.QRect(10, 70, 481, 51))
        ...
        self.work_submit.setGeometry(QtCore.QRect(500, 70, 51, 51))
        ...
        self.work_submit.setIconSize(QtCore.QSize(25, 25))
        self.work_submit.setObjectName("work_submit")

        self.work_minus = QtWidgets.QPushButton(self.work_todo1)
        self.work_minus.setGeometry(QtCore.QRect(560, 70, 51, 51))
        self.work_minus.setStyleSheet("\n"
                                      "QPushButton {\n"
                                      "background-color: rgb(234, 234, 234);\n"
                                      "    border: 0px;\n"
                                      "    border-radius: 10px;\n"
                                      ...
                                      "    border: 0px;\n"
                                      " }")
        self.work_minus.setText("")
        self.work_minus.setIcon(icon5)
        self.work_minus.setIconSize(QtCore.QSize(25, 25))
        self.work_minus.setObjectName("work_minus")
        ...
        self.work_counter.setStyleSheet("font: 15pt \"Century Gothic\";\n"
                                        "color: rgb(112, 112, 112);\n"
                                        "border: 3px solid rgb(214, 214, 214) ;\n"
                                        "border-width: 2px;\n"
                                        "border-radius: 5px; font-weight: bold;")
        ...
        # change image file path to the local directory
        ...
        self.completed_tasks.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("C:\\Users\\mikab\\Desktop\\../Downloads/star.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        self.important.setIcon(icon6)
        ...
        self.completed_todo.setIconSize(QtCore.QSize(25, 25))

        self.completed_todo.setObjectName("completed_todo")
        MainWindow.setCentralWidget(self.centralwidget)

        self.home_minus = QtWidgets.QPushButton(self.home_todo1)
        self.home_minus.setGeometry(QtCore.QRect(560, 70, 51, 51))
        self.home_minus.setStyleSheet("\n"
                                      "QPushButton {\n"
                                      "background-color: rgb(234, 234, 234);\n"
                                      "    border: 0px;\n"
                                      "    border-radius: 10px;\n"
        ...
        self.home_minus.setIcon(icon5)
        self.home_minus.setIconSize(QtCore.QSize(25, 25))
        self.home_minus.setObjectName("home_minus")



        self.important_star_imp = QtWidgets.QPushButton(self.home_todo1)
        self.important_star_imp.setGeometry(QtCore.QRect(-10, 50, 51, 41))
        self.important_star_imp.setStyleSheet("\n"
                                              "QPushButton {\n"
                                              "background-color: rgba(255, 255, 255,0);\n"
                                              "font: 23pt \"MS Shell Dlg 2\";\n"
                                              "    color: rgb(214, 214, 214);\n"
                                              ...
                                              "    border: 0px;\n"
                                              " }")
        self.important_star_imp.setIconSize(QtCore.QSize(40, 40))
        self.important_star_imp.setObjectName("important_star_imp")


        self.school_star = QtWidgets.QPushButton(self.school_todo1)
        self.school_star.setGeometry(QtCore.QRect(-10, 50, 51, 41))
        self.school_star.setStyleSheet("\n"
                                       "QPushButton {\n"
                                       "background-color: rgba(255, 255, 255,0);\n"
                                       "font: 23pt \"MS Shell Dlg 2\";\n"
                                       "    color: rgb(214, 214, 214);\n"
                                       ...
                                       "    border: 0px;\n"
                                       " }")
        self.school_star.setIconSize(QtCore.QSize(40, 40))
        self.school_star.setObjectName("school_star")

        self.work_star = QtWidgets.QPushButton(self.work_todo1)
        self.work_star.setGeometry(QtCore.QRect(-10, 50, 51, 41))
        self.work_star.setStyleSheet("\n"
                                     "QPushButton {\n"
                                     "background-color: rgba(255, 255, 255,0);\n"
                                     "font: 23pt \"MS Shell Dlg 2\";\n"
                                     "    color: rgb(214, 214, 214);\n"
                                     ...
                                     "    border: 0px;\n"
                                     " }")
        self.work_star.setIconSize(QtCore.QSize(40, 40))
        self.work_star.setObjectName("work_star")
        ...
        # ======================================Add Item ===============================================
        add_task = AddData()
        self.todo_submit.clicked.connect(lambda x: add_task.write_todo(self.todo_addtask.text(), self.todo_list_widget, self.counter_todo, self.todo_addtask, 'ToDo-Datas', self.stickypad_todo))
        self.home_submit.clicked.connect(lambda x: add_task.write_todo(self.home_addtask.text(), self.home_list_widget, self.home_counter, self.home_addtask, 'ToDo-Datas-Home',self.stickypad_todo))
        self.school_submit.clicked.connect(lambda x: add_task.write_todo(self.school_addtask.text(), self.school_lists, self.school_counter, self.school_addtask, 'ToDo-Datas-School',self.stickypad_todo))
        self.work_submit.clicked.connect(lambda x: add_task.write_todo(self.work_addtask.text(), self.work_lists, self.work_counter, self.work_addtask, 'ToDo-Datas-Work', self.stickypad_todo))
        ...
        ReadData.read_todo(self.completed_tasks, 'CompleteItem')
        ...
        # ====================================== Double Click Remove ===============================================
        add_click = DoubleClickAdd()

        self.todo_list_widget.itemDoubleClicked.connect(lambda x: add_click.completed_items(x, self.todo_list_widget, self.completed_tasks, self.counter_todo))
        self.home_list_widget.itemDoubleClicked.connect(lambda x: add_click.completed_items(x, self.home_list_widget, self.completed_tasks, self.home_counter))
        self.school_lists.itemDoubleClicked.connect(lambda x: add_click.completed_items(x, self.school_lists, self.completed_tasks, self.school_counter))
        self.work_lists.itemDoubleClicked.connect(lambda x: add_click.completed_items(x, self.work_lists, self.completed_tasks, self.work_counter))

        self.item_select = ''

        self.todo_list_widget.itemClicked.connect(lambda x: self.selected_item(x))
        self.home_list_widget.itemClicked.connect(lambda x: self.selected_item(x))
        self.school_lists.itemClicked.connect(lambda x: self.selected_item(x))
        self.work_lists.itemClicked.connect(lambda x: self.selected_item(x))



        self.todo_minus.clicked.connect(lambda x: self.delete_items(self.todo_list_widget, self.counter_todo))
        self.home_minus.clicked.connect(lambda x: self.delete_items(self.home_list_widget, self.home_counter))
        self.school_minus.clicked.connect(lambda x: self.delete_items(self.school_lists, self.school_counter))
        self.work_minus.clicked.connect(lambda x: self.delete_items(self.work_lists, self.work_counter))
        ...
        self.important_star.clicked.connect(lambda x: add_task.star_clicked_change(self.important_star, self.todo_addtask))
        self.important_star_imp.clicked.connect(lambda x: add_task.star_clicked_change(self.important_star_imp, self.home_addtask))
        self.school_star.clicked.connect(lambda x: add_task.star_clicked_change(self.school_star, self.school_addtask))
        self.work_star.clicked.connect(lambda x: add_task.star_clicked_change(self.work_star, self.work_addtask))


        #self.completed_tasks.itemDoubleClicked.connect(self.item_double_clicked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.important_star.setText(_translate("MainWindow", "★"))
        self.important_star_imp.setText(_translate("MainWindow", "★"))
        self.school_star.setText(_translate("MainWindow", "★"))
        self.work_star.setText(_translate("MainWindow", "★"))

    def selected_item(self, item_text):
        self.item_select = item_text

    def delete_items(self, widget, counter):
        if self.item_select:
            widget.takeItem(widget.row(self.item_select))
